...
if (interactive() && Sys.getenv("TERM_PROGRAM") != "RStudio") {
  options(viewer = NULL)
  # Just the command name, no arguments needed
  options(browser = "zen-browser") # or chromium, brave, etc.

  if (requireNamespace("httpgd", quietly = TRUE)) {
    options(httpgd.viewer = TRUE)
  }
}
